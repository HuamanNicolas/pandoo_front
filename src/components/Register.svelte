<script>
  import { Mail, Lock, User, UserCircle, IdCard, CheckCircle, ArrowLeft, AtSign } from '@lucide/svelte';
        ...
        <div class="card-body-custom">
          {#if loading && !error}
            <div class="loading-overlay">
              ...
              <p class="loading-text">{success ? 'Redirigiendo al dashboard...' : 'Creando tu cuenta...'}</p>
            </div>
          {:else}
            {#if error}
