      ...
      <div class="resumen-container">
        <div class="resumen-card">
          ...
          <div class="resumen-stats">
            <div class="stat">
              <div class="stat-numero">{actividadesStore.respuestasCorrectas}</div>
            ...
            <div class="stat">
              <div class="stat-numero">{actividadesStore.progresoPorcentaje}%</div>
          ...
          <div class="resumen-mensaje">
            {#if actividadesStore.progresoPorcentaje === 100}
              <p class="excelente">¡Excelente trabajo! Respondiste todo correctamente.</p>
      ...
      <div class="progress-container">
        <div class="progress-vertical">
          <div 
            ...
            style="height: {((actividadesStore.ejercicioActualIndex + 1) / actividadesStore.totalEjercicios) * 100}%"
          ></div>
        </div>
